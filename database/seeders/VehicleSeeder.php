    ...
    public function run()
    {
        DB::table('vehicle')->insert([
            ...
            [
                ...
                'image' => 'images/ford_mustang.jpeg',
            ],
            [
                'brand' => 'BMW',
                'model' => 'X5',
                'price_per_day' => 100.00,
                'image' => 'images/bmw_x5.jpeg',
            ],
            [
                'brand' => 'Honda',
                'model' => 'Civic',
            ...
            [
                ...
                'image' => 'images/nissan_altima.jpeg',
            ],
            [
                'brand' => 'Kia',
                'model' => 'Sportage',
                'price_per_day' => 145.00,
                'image' => 'images/kia_sportage.jpeg',
            ],
            [
                'brand' => 'Mazda',
                'model' => 'CX-5',
                'price_per_day' => 155.00,
                'image' => 'images/mazda_cx5.jpeg',
            ],
            [
                'brand' => 'Volkswagen',
                'model' => 'Passat',
                'price_per_day' => 165.00,
                'image' => 'images/vw_passat.jpeg',
            ],
        ]);
    }
}

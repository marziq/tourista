            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="phone">+60-198389538</div>
                        <div class="social">
                ...
                <div class="row">
                    <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                        <div class="logo_container">
                            <div class="logo"><a href="/"><img src="{{ asset('images/logo.png') }}" alt="">tourista</a></div>
                        </div>
                        ...
                        <div class="content_search ml-lg-0 ml-auto">
                            ...
                            width="17px" height="17px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                                            <path class="mag_glass" fill="#426253;" d="M78.438,216.78c0,57.906,22.55,112.343,63.493,153.287c40.945,40.944,95.383,63.494,153.287,63.494
                                    ...
                                    <g>
                                        <g>
                                            <path class="mag_glass" fill="#426253" d="M6.057,505.942c4.038,4.039,9.332,6.058,14.625,6.058s10.587-2.019,14.625-6.058L171.268,369.98
                ...
                <div class="col-lg-3 footer_column">
                    <div class="footer_col">
                        <div class="footer_content footer_about">
                            ...
                            <p class="footer_about_text">Tourista, Your one stop website for your Holiday</p>
                        ...
                        <div class="footer_content footer_contact">
                            <ul class="contact_info_list">
                                <li class="contact_info_item d-flex flex-row">
                                    ...
                                    <div class="contact_info_text">Gombak, Malaysia</div>
                                </li>
                                <li class="contact_info_item d-flex flex-row">
                                ...
                                <li class="contact_info_item d-flex flex-row">
                                    ...
                                    <div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">contactme@tourista.com</a></div>
                                </li>
                                <li class="contact_info_item d-flex flex-row">
                                    <div><div class="contact_info_icon"><img src="{{ asset('images/planet-earth.svg') }}" alt=""></div></div>
                                    <div class="contact_info_text"><a href="https://tourista.com">www.tourista.com</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
